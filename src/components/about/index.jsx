...
const ItemLayout = ({ children, className }) => {
  return (
    <div
      className={clsx(
        " custom-bg p-8 rounded-xl flex justify-center items-center space-y-8",
        className
      )}
    >
      {children}
    ...
    <section className="py-0 w-full">
      <div className="grid grid-cols-12 gap-8 w-full">
        <ItemLayout className={"col-span-8 row-span-2 flex-col items-start"}>
          <h2 className="text-2xk text-left w-full capitalize">
        ...
        <ItemLayout className={"col-span-4"}>
          ...
          <p className="font-semibold w-full text-left text-4xl text-accent ">
