  ...
  return (
    ...
    space-y-4"
      ...
      focus:ring-2 focus:ring-accent/50 custom-bg"
        ...
        {errors.name && (
          <span className="inline-blocks self-start text-red-600  ">
            {errors.name.message}
          </span>
        )}
      ...
      hover:shadow-glass-sm backdrop-blur-sm text-foreground focus:outline-none focus:ring-2 focus:ring-accent/50 capitalize "
          type="submit"
        />
      </motion.form>
    </>
