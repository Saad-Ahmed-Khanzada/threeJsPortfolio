        ...
        <div className="fixed inset-0 bg-background/60 backdrop-blur-sm flex items-center justify-center">
            ...
            py-8 px-6 xs:px-10 sm:px-16 rounded shadow-glass-inset text-center space-y-8">
                ...
                <div className="flex items-center justify-center space-x-4 ">
                    <button onClick={toggle} className="mr-2 px-4 py-2 border border-accent/30 border-solid hover:shadow-glass-sm rounded">Yes</button>
                    <button onClick={onClose} className="mr-2 px-4 py-2 border border-accent/30 border-solid hover:shadow-glass-sm rounded">No</button>
                </div>
